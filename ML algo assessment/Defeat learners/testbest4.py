...
#     lr = mean_squared_error(y_test, y_pred)**0.5
    
#     m = DecisionTreeRegressor().fit(X_train, y_train)
#     y_pred = m.predict(X_test)

#     dt = mean_squared_error(y_test, y_pred)**0.5
#     return dt < 0.9 * lr

# errors = 0
# for i in range(10000):
#     if not evaluate_dt(i):
#         errors += 1
# errors


# def evaluate_lr(seed):
